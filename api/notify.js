...
const IMPORTANT = [
  ...
  { md: '01-13', name: "Rauf Denktaş'ı Anma Günü", tag: 'KKTC' },
  { md: '02-14', name: 'Sevgililer Günü', tag: 'Pazarlama' },
  { md: '02-18', name: 'Ramazan Başlangıcı (yaklaşık)', tag: 'Dini' },
  { md: '03-08', name: 'Dünya Kadınlar Günü', tag: 'Pazarlama' },
  { md: '03-16', name: 'Kadir Gecesi (yaklaşık)', tag: 'Dini' },
  { md: '03-18', name: 'Çanakkale Zaferi ve Şehitleri Anma', tag: 'TR' },
  { md: '03-20', name: 'Ramazan Bayramı (yaklaşık)', tag: 'Dini' },
  { md: '03-21', name: 'Nevruz', tag: 'TR' },
  { md: '04-23', name: 'Ulusal Egemenlik ve Çocuk Bayramı', tag: 'TR·KKTC' },
  { md: '05-01', name: 'Emek ve Dayanışma Günü', tag: 'TR·KKTC' },
  { md: '05-10', name: 'Anneler Günü', tag: 'Pazarlama' },
  { md: '05-19', name: "Atatürk'ü Anma, Gençlik ve Spor Bayramı", tag: 'TR·KKTC' },
  { md: '05-27', name: 'Kurban Bayramı (yaklaşık)', tag: 'Dini' },
  { md: '06-21', name: 'Babalar Günü', tag: 'Pazarlama' },
  { md: '07-15', name: 'Demokrasi ve Milli Birlik Günü', tag: 'TR' },
  { md: '07-20', name: 'Barış ve Özgürlük Bayramı (1974 Barış Harekâtı)', tag: 'KKTC' },
  { md: '08-01', name: 'Toplumsal Direniş (TMT) Bayramı', tag: 'KKTC' },
  { md: '08-30', name: 'Zafer Bayramı', tag: 'TR·KKTC' },
  { md: '09-04', name: "Fazıl Küçük'ü Anma", tag: 'KKTC' },
  { md: '10-04', name: 'Dünya Hayvanları Koruma Günü', tag: 'Pazarlama' },
  { md: '10-29', name: 'Cumhuriyet Bayramı', tag: 'TR' },
  { md: '11-10', name: "Atatürk'ü Anma Günü (10 Kasım)", tag: 'TR·KKTC' },
  { md: '11-15', name: 'KKTC Cumhuriyet Bayramı (Kuruluş)', tag: 'KKTC' },
  { md: '11-24', name: 'Öğretmenler Günü', tag: 'TR' },
  { md: '11-27', name: 'Kara Cuma (Black Friday)', tag: 'Pazarlama' },
